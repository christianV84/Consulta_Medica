...
{
    public partial class VConsultarProcedimiento : Form
    {
        public VConsultarProcedimiento()
        {
            InitializeComponent();
        }
        ...
        private void VConsultarProcedimiento_Load(object sender, EventArgs e)
        {
        ...
        private void btnProcesarProcedimiento_Click(object sender, EventArgs e)
        {
            ...
            //ponemos el nombre del procedimiento
            SqlCommand cmd = new SqlCommand(cbxEscogerProcedimiento.Text, cnx);
            cmd.CommandType = CommandType.StoredProcedure;

            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataTable tabla = new DataTable();
            sda.Fill(tabla);
            dgvConsultarProcedimiento.DataSource = tabla;
        }
